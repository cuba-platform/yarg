...
public class DocxFormatter extends AbstractFormatter {
    private List<TagHandler> tagHandlers = new ArrayList<TagHandler>();
    ...
    public void renderDocument() {
        ...
        for (TableWrapper resultingTable : documentWrapper.tables) {
            ...
            List<Band> bands = rootBand.findBandsRecursively(resultingTable.bandName);
    ...
    private class TextWrapper {
        ...
        private TextWrapper(Text text, String alias, List<TagHandler> tagHandlers) {
            this.text = text;
            this.alias = alias;
        ...
        void fillTextWithBandData() {
            ...
            if (paramValue != null && valueFormats != null && valueFormats.containsKey(alias)) {
                ...
                for (TagHandler tagHandler : this.tagHandlers) {
                    ...
                    if (matcher.find()) {
                        tagHandler.handleTag(wordprocessingMLPackage, text, paramValue, matcher);
                        handled = true;
                    }
                }
            }
    ...
    private class TableWrapper {
        ...
        public void fillRowFromBand(Tr row, final Band band) {
        ...
        public List<Object> apply(Object o) {
            if (o instanceof Text) {
                ...
                if (matcher.find()) {
                    ...
                    textWrappers.add(new TextWrapper(handlingText, alias, tagHandlers));
                    ...
                    if (matcher.find()) {
                        ...
                        textWrappers.add(new TextWrapper(handlingText, matcher.group(1), tagHandlers));
                    }
                }
            }
